...
var regexCover_s0 = regexp2.MustCompile(`cover|うたっ?てみた|歌ってみた|歌みた|踊ってみた|翻唱|翻唱|カバ|試著唱了|试着唱了|\sver\.|(arrange\s|弾き語り)\s?ver`, regexp2.IgnoreCase)
...
var regexStream_s2 = regexp2.MustCompile(`【(sing|song|歌)】|歌＆|歌(と|＆)(ピアノ|雑談|作業|演奏)|(ピアノ|雑談|作業|演奏)と歌|sing a song|singing|stream|(うた|歌).{0,3}(れんしゅう|練)|朝歌|(歌|演奏)枠(?!切り抜き)|うたわく|】(sing|歌|うた)(！|。|!|\.)|^(sing|歌|うた)(！|。|!|\.)|歌回|歌回|うたう|歌う|(うた|歌)い.?ま.?す|歌配信|弾き語り(?!\s?ver)|お歌|歌ったり|.araoke|(うた|歌|sing).*(guerilla|げりら|ゲリラ)|(guerilla|げりら|ゲリラ).*(うた|歌|sing)|生.{0,6}(Live|ライブ|放送)\s|mini concert`, regexp2.IgnoreCase)
