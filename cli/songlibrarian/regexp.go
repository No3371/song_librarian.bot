...
var regexOriginal_s1 = regexp2.MustCompile(`original(?!\s?mv)|オリジナル|原創|music\s?video|pv|mv|ＭＶ|official|feat\.|ft\.|new single|M.?V.+from.+album|(1st|2nd|3rd|4th|5th|6th|7th|8th)\s?single|【(1st|2nd|3rd|4th|5th|6th|7th|8th)\s?アルバム\s?収録曲】`, regexp2.IgnoreCase | regexp2.Multiline)
