...
var regexCover_s0 = regexp2.MustCompile(`cover(?!\s?live)|うたっ?てみた|歌いました|歌ってみた|歌みた|踊ってみた|翻唱|翻唱|カバ|試著唱了|试着唱了|\sver\.|(arrange\s|弾き語り)\s?ver`, regexp2.IgnoreCase)
var regexOriginal_s1 = regexp2.MustCompile(`original(?!\s?mv)|オリジナル|原創|music video|mv|official|feat\.|ft\.|new single|M.?V.+from.+album`, regexp2.IgnoreCase)
...
var regexNamedStream = regexp2.MustCompile(`【YouTube Live】波羅ノ鬼 - Harano oni|響歌シノのヒビカセ`, regexp2.IgnoreCase)
