...
var regexStream_s2 = regexp2.MustCompile(`【SING】|singing|stream|歌枠(?!切り抜き)|うたわく|歌回|歌回|うたう|歌う|歌い.?ま.?す|歌配信|歌練|弾き語り|お歌|歌ったり|karaoke|(うた|歌|sing).*(guerilla|ゲリラ)|(guerilla|ゲリラ).*(うた|歌|sing)|生.{0,6}(Live|ライブ)`, regexp2.IgnoreCase)
