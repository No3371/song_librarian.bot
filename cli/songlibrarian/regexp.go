...
var regexStream_s2 = regexp2.MustCompile(`【SING】|singing|stream|(うた|歌).{0,3}(れんしゅう|練)|歌枠(?!切り抜き)|うたわく|うた(！|。)|歌回|歌回|うたう|歌う|歌い.?ま.?す|歌配信|弾き語り(?!\s?ver)|お歌|歌ったり|karaoke|(うた|歌|sing).*(guerilla|ゲリラ)|(guerilla|ゲリラ).*(うた|歌|sing)|生.{0,6}(Live|ライブ|放送)\s`, regexp2.IgnoreCase)
...
var regexBadForOriginal = regexp2.MustCompile(`cover|てみた|(original|オリジナル)\s?mv.+(てみた|cover)|(てみた|cover).+(original|オリジナル)\s?mv`, regexp2.IgnoreCase)
