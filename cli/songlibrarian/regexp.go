...
var regexCover_s0 = regexp2.MustCompile(`(cover|𝑐𝑜𝑣𝑒𝑟)(?!\s?live)|うたっ?てみた(?!.{0,4}(枠|配信))|歌いました(?!.{0,4}(枠|配信))|歌ってみた(?!.{0,4}(枠|配信))|歌みた|踊ってみた|翻唱|翻唱|カバ|試著唱了|试着唱了|(?<!(full|short|tv.{0,4}|remix\s?))ver\.|(arrange\s|弾き語り)\s?ver\s`, regexp2.IgnoreCase | regexp2.Multiline)
var regexOriginal_s1 = regexp2.MustCompile(`original(?!\s?mv)|オリジナル|原創|music\s?video|mv|ＭＶ|official|feat\.|ft\.|new single|M.?V.+from.+album|(1st|2nd|3rd|4th|5th|6th|7th|8th)\s?single|【(1st|2nd|3rd|4th|5th|6th|7th|8th)\s?アルバム\s?収録曲】`, regexp2.IgnoreCase | regexp2.Multiline)
var regexStream_s2 = regexp2.MustCompile(
`歌ってお(し|知)らせ|【\s?(sing(ing)?|song|歌|唱歌|歌枠)\s?】|(うた|歌|歌枠|sing)\s?(ながら|と|＆|\+|＋|and)\s?(はなし|話し|ピアノ|雑談|作業|演奏|talk)|(はなし|話し|ピアノ|雑談|作業|演奏|talk)\s?(ながら|と|＆|\+|＋|and)\s?(うた|歌|sing)|sing a song|sing songs|(sing|song|歌|piano).{0,8}stream|(うた|歌).{0,3}(れんしゅう|練)|朝歌|(歌|演奏).{0,2}枠|うたわく|(歌|うた)(！|。|雑談)|歌回|歌回|うたう|歌う|(うた|歌)い.?ま.?す|歌.{0,4}配信|弾き語り(?!\s?ver)|お歌|おうた|(うた|歌).{0,7}(時間|live)|【LIVE #\d{1,3}】|歌ったり|.araoke|カラオケ|(うた|歌|sing).*(guerilla|げりら|ゲリラ)|(guerilla|げりら|ゲリラ).{0,5}(うた|歌|sing)|生.{0,6}(Live|ライブ|放送|歌コラボ)|mini live|ミニライブ|(mini|live) concert|virtual.+?concert|耐久.{0,12}(曲|うた|歌|sing)|(曲|うた|歌|sing).{0,12}耐久|cover live|カバーライブ`, regexp2.IgnoreCase | regexp2.Multiline)
...
var regexNamedOriginal = regexp2.MustCompile(`- 長瀬有花 \((Official|Original)\)`, regexp2.IgnoreCase | regexp2.Multiline)
