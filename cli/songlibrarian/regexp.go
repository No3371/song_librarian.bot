...
var regexStream_s2 = regexp2.MustCompile(`sing|stream|歌枠(?!切り抜き)|歌回|歌回|うたう|歌う|歌い.?ま.?す|歌配信|弾き語り|お歌|歌ったり|karaoke|(うた|歌)?ゲリラ.*?(うた|歌)|(うた|歌)ゲリラ.*?(うた|歌)?`, regexp2.IgnoreCase)
